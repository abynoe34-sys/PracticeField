...
**Distribution (285):** by tier — 209 `judge` (Yes+Needs Motion), 66 `proxy_only` (Partial), 10 `skip` (No). Thresholds — 275 `Draft`, 10 `Not Applicable` (the `No` rows). By variation — Pocket Movement 53, Gun 52, Pistol 52, Under Center 51, Throwing 40, Play Action 13, Bootleg 12, Hand Off 12.
