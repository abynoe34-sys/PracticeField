...
- **`coaching_cue` and `correction_strategy` are blank on all 285 by design** — authored later in the owner's voice. So the catalogue currently supplies *what to watch* + *the mistake*, but not yet *the correction* (the third North-Star beat). This is the highest-value human work remaining.
